...
import { InlineFeedbackMessage, InlineFeedbackMessageType } from '../../structured-information';
        ...
        >
          {[
            ...
            .map(([message, messageType]) => (
              <InlineFeedbackMessage key={messageType} messageType={messageType as InlineFeedbackMessageType}>
                {message}
